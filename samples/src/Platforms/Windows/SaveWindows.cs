...
namespace VControl.Samples.Services
{
    public partial class SaveService
    {
        public partial bool SavePic(string filename, MemoryStream stream)
        {
            //StorageFile stFile;
        ...
        public partial (bool, string) CheckFileExists(string filename, bool isPicture = false)
        {
        ...
        /// ¼ì²é¸üÐÂAPP
        /// </summary>
        public partial async Task UpdateApp()
        {
