...
public partial class VCheckBoxView : ContentPageBase<VCheckBoxViewModel>
{
    ...
    public static readonly BindableProperty CommandProperty = BindableProperty.Create(nameof(Command), typeof(ICommand), typeof(VCheckBox), default(ICommand),
    ...
    public static readonly BindableProperty CommandParameterProperty = BindableProperty.Create(nameof(CommandParameter), typeof(object), typeof(VCheckBox), default(object),
        propertyChanged: (bindable, oldvalue, newvalue) =>
        {
            var vCheckBox = (VCheckBox)bindable;
    ...
    typeof(bool), typeof(VCheckBox), false, BindingMode.TwoWay, propertyChanged: OnIsCheckedPropertyChanged);
    ...
    public static readonly BindableProperty IsIndeterminateProperty = BindableProperty.Create(nameof(IsIndeterminate),
    typeof(bool), typeof(VCheckBox), false, BindingMode.TwoWay, propertyChanged: OnIsIndeterminatePropertyChanged);

    private static void OnIsIndeterminatePropertyChanged(BindableObject bindable, object oldValue, object newValue)
    {
        var vCheckBox = (VCheckBox)bindable;
