...
public partial class VExpanderView : ContentPageBase<VExpanderViewModel>
{
    ...
    private void VExpander_Loaded(object sender, EventArgs e)
    {
        ...
        if (this.MainSlot != default)
        {
            (this.FindByName("MainContent") as ContentView).Content = (View)this.MainSlot;
        }
    ...
    private void UpdateExpandDirection()
    {
        ...
        this.MainLayout.Children.Remove(MainSlot);
        ...
        switch (ExpandDirection)
        {
            case ExpandDirection.Down:
                ...
                this.MainLayout.Children.Add(MainSlot);
                Grid.SetRow(MainSlot as BindableObject, 1);
                break;
            case ExpandDirection.Up:
                ...
                this.MainLayout.Children.Add(MainSlot);
                Grid.SetRow(MainSlot as BindableObject, 0);
                this.MainLayout.Children.Add(HeaderSlot);
